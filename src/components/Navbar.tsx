    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="flex items-center justify-between h-12">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#2563EB] via-blue-600 to-indigo-600 flex items-center justify-center shadow-[0_2px_10px_rgba(37,99,235,0.25)] transition-transform duration-300 group-hover:scale-105">
              <span className="text-white text-xs font-mono font-black tracking-tighter">BA</span>
            </div>
