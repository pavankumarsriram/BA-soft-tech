...
import { DIGITAL_SERVICES } from '../data';
...
export default function DigitalSolutionsSection({ onScrollToSection }: DigitalSolutionsSectionProps) {
  return (
    <section id="digital" className="py-8 bg-transparent border-t border-slate-100/20">
